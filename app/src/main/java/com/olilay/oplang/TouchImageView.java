...
/** This is a class found at http://www.c-sharpcorner.com/UploadFile/88b6e5/multi-touch-panning-pinch-zoom-image-view-in-android-using/
 * Thanks to the author of this class
 * Slightly modified by Oliver (added double-tap, various other improvements)
 **/
...
public class TouchImageView extends ImageView {
    ...
    private class ScaleListener extends ScaleGestureDetector.SimpleOnScaleGestureListener {
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            setZoom(detector.getScaleFactor(), detector.getFocusX(), detector.getFocusY());
    ...
    private void setZoom(float scaleFactor, float X, float Y)
    {
